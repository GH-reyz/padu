...
NUMBER_OF_CLIENTS=$(grep -c -E "^### " "/usr/local/etc/xray/xtls.json")
	if [[ ${NUMBER_OF_CLIENTS} == '0' ]]; then
        ...
        echo -e "\\E[0;41;36m Renew XRAY Vless TCP XTLS Account \E[0m"
        echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
		echo ""
...
sed -i "s/### $user $exp/### $user $exp4/g" /usr/local/etc/xray/xtls.json
systemctl restart xray@xtls.service
service cron restart
clear
echo ""
echo " XRAY Vless TCP XTLS Account Renewed"
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
