...
wget -O del-ssh "https://raw.githubusercontent.com/${GitUser}/padu/main/add-user/del-ssh.sh"
wget -O member "https://raw.githubusercontent.com/${GitUser}/padu/main/member.sh"
wget -O delete "https://raw.githubusercontent.com/${GitUser}/padu/main/add-user/delete.sh"
wget -O cek-ssh "https://raw.githubusercontent.com/${GitUser}/padu/main/add-user/cek-ssh.sh"
