...
until [[ $user =~ ^[a-zA-Z0-9_]+$ && ${user_EXISTS} == '0' ]]; do
        ...
        echo -e "\E[0;41;36m      Add Trojan GO WS Account     \E[0m"
        echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
trojanlinkdg="trojan-go://${user}@162.159.134.61:${trgows}?sni=${domain}&type=ws&host=${domain}&path=/trojangows&encryption=none#TROJAN_GO_DIGI_${user}"

cat > /usr/local/etc/xray/$user-TRGO-STD.yaml <<EOF
port: 7890
socks-port: 7891
redir-port: 7892
mixed-port: 7893
...
# Move Yaml To html
mv /usr/local/etc/xray/$user-TRGO-STD.yaml /home/vps/public_html/$user-TRGO-STD.yaml
mv /usr/local/etc/xray/$user-TRGO-WS.yaml /home/vps/public_html/$user-TRGO-WS.yaml
mv /usr/local/etc/xray/$user-TRGODIGI.yaml /home/vps/public_html/$user-TRGODIGI.yaml
